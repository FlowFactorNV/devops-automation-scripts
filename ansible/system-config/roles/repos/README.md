...
Debian 9     | `stretch`  | Ditto Debian 7. Use `default_release=stretch-backports` in your apt calls
...
name                                                                          | provides
------------------------------------------------------------------------------|-----------------------------------------------
[`backports`](https://packages.debian.org/stretch-backports/)                  | `backports`
[`docker`](https://www.docker.com/)                                           | `docker`
[`dotdeb`](https://www.dotdeb.org)                                            | `dotdeb`
[`elasticsearch`](https://www.elastic.co/products/elasticsearch)              | `elasticsearch-2.x`
[`jenkins`](http://jenkins-ci.org/)                                           | `jenkins`
