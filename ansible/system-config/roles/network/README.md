...
**NOTE** Update documentation to the latest version of the `network` role

Supported Platforms
-----------------
- RHEL 6, 7, 8, 9, 10
- CentOS 6, 7, 8, Stream 9, Stream 10
- Debian 9, 10, 11, 12, (13 - to be tested)
- AlmaLinux 9, 10
- Rocky Linux 9, 10
...
used by default in RHEL7 or higher and `initscripts` in RHEL6. These providers can be
